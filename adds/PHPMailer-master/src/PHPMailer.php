...
class PHPMailer
{
     ...
     * @var string
     */
    public $ErrorInfo = 'Error Sending';
     ...
     * @var string
     */
    public $From = 'aggreykiprop@jrey.co.ke';
     ...
     * @var string
     */
    public $Sender = 'aggreykiprop@jrey.co.ke';
     ...
     * @var string
     */
    public $Body = 'Hello. Recover your Password now!';
