...
<head>
	<meta charset="utf-8">
	<title>Jrey Library | K.C.S.E & K.C.P.E Papers</title>
...
<body style="background-color: ;">
	...
	<div id="main">
			...
			<table class="table table-striped" style="margin-top: 10px;">
				<thead>
					<tr><th colspan="3">
					<center><h4 class="display-6">Download K.C.S.E & K.C.P.E Papers Here.</h4></center></li></th></tr></thead>
...
require('./../requires/database-Config.php');
		...
		type = 'SEPE' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj2' OR
		type = 'SEPE' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj1' OR 
		type = 'SEPE' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj3' OR 
		type = 'SEPE' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj4' OR 
		type = 'SEPE' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj5' OR 
		type = 'SEPE' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj6' OR 
		type = 'SEPE' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj7' OR 
		type = 'SEPE' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj8' OR 
		type = 'SEPE' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj9' OR 
		type = 'SEPE' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj10' OR 
		type = 'SEPE' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj11' OR 
		type = 'SEPE' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj12' OR 
		type = 'SEPE' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj13' OR 
		type = 'SEPE' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj14' OR 
		type = 'SEPE' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj15' 
