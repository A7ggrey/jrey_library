...
<style type="text/css">
	...
	<div id="mySidenav" class="sidenav">
		...
		<li class="list-group-item"><a href="all-exams.php">
			<img src="./../../../icons/file-earmark-word.svg" class="icon">&nbsp;&nbsp;Exams</a></li>

		<li class="list-group-item"><a href="all-past-papers.php">
			<img src="./../../../icons/file-earmark-pdf.svg" class="icon">&nbsp;&nbsp;Past Papers</a></li>

		<li class="list-group-item"><a href="kc-se-pe-papers.php">
			<img src="./../../../icons/file-earmark-pdf.svg" class="icon">&nbsp;&nbsp;K.C.S.E and K.C.P.E Revision Papers</a></li>

	    <li class="list-group-item"><a href="mocks.php">
		...
		<li class="list-group-item"><a href="all-notes.php">
