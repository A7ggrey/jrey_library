...
<body><b>
	...
	<div class="">
		...
		<p class="margin-left"><label>Phone Number <span style="color: red;">*</span></label>
			...
			<input type="text" name="phonenumber" placeholder="" id="phone" class="form-control">
			</div>
		</p>
		...
		<p class="margin-left">
			...
			<span>I agree with <a href="#" class="alert-link text-decoration-none">Jrey library's terms.</a></span>
		</p>
