...
require('./../requires/database-Config.php');
 ...
 $stmt = $dbconnect->prepare('SELECT sessionkey, profilepic, email, firstname, secondname, lastname, gender, code, phonenumber, level, class, school FROM userstudents WHERE sessionkey = ?');

          $stmt->bind_param('s', $_SESSION['name']);
            $stmt->execute();
            $stmt->bind_result($sessionkey, $profilepic, $email, $firstname, $secondname, $lastname, $gender, $code, $phonenumber, $level, $class, $school);
