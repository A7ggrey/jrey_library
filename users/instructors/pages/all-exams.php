...
<head>
	<meta charset="utf-8">
	<title>Jrey Library | Download Exams</title>
...
<body style="background-color: ;">
	...
	<div id="main">
			...
			<table class="table table-striped" style="margin-top: 10px;">
				<thead>
					<tr><th colspan="3">
					<center><h4 class="display-6">Download Exams Here.</h4></center></li></th></tr>
...
require('./../requires/database-Config.php');
		...
		type = 'Exams' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj2' OR
		type = 'Exams' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj1' OR 
		type = 'Exams' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj3' OR 
		type = 'Exams' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj4' OR 
		type = 'Exams' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj5' OR 
		type = 'Exams' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj6' OR 
		type = 'Exams' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj7' OR 
		type = 'Exams' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj8' OR 
		type = 'Exams' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj9' OR 
		type = 'Exams' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj10' OR 
		type = 'Exams' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj11' OR 
		type = 'Exams' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj12' OR 
		type = 'Exams' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj13' OR 
		type = 'Exams' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj14' OR 
		type = 'Exams' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj15' 
		...
		while ($rows = mysqli_fetch_assoc($run2)) { ?>
			...
			<td><spanx><b class="bb">Updated on </b> <?php echo $rows['uplddate']?></span></td></tr>
