...
if (isset($_POST['submit'])) {
   ...
   $sql = "UPDATE userstudents SET profilepic='$pname' WHERE id='$currentUser'";
...
<body>
	...
	<form method="POST" action="" class="container" enctype="multipart/form-data" style="margin-top: 40px;">
		...
		<p><input type="file" name="profilepic" class="form-control" accept="image/*"></p>

		<p><input type="submit" name="submit" value="Upload Photo" class="btn btn-primary width-100"></p>
	</form>
