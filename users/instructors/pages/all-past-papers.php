...
<head>
	<meta charset="utf-8">
	<title>Jrey Library | Past Papers</title>
...
<body style="background-color: ;">
	...
	<div id="main">
			...
			<table class="table table-striped" style="margin-top: 10px;">
				<thead>
					<tr><th colspan="3">
					<center><h4 class="display-6">Download Past Papers Here.</h4></center></li></th></tr></thead>
...
require('./../requires/database-Config.php');
		...
		type = 'Past Papers' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj2' OR
		type = 'Past Papers' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj1' OR 
		type = 'Past Papers' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj3' OR 
		type = 'Past Papers' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj4' OR 
		type = 'Past Papers' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj5' OR 
		type = 'Past Papers' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj6' OR 
		type = 'Past Papers' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj7' OR 
		type = 'Past Papers' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj8' OR 
		type = 'Past Papers' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj9' OR 
		type = 'Past Papers' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj10' OR 
		type = 'Past Papers' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj11' OR 
		type = 'Past Papers' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj12' OR 
		type = 'Past Papers' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj13' OR 
		type = 'Past Papers' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj14' OR 
		type = 'Past Papers' AND level = '$my_Level' AND class = '$my_Class' AND subject = '$subj15' 
